...
func (m *MockFlusher) Flush(rules []models.Rule) []models.Rule {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Flush", rules)
	ret0, _ := ret[0].([]models.Rule)
	return ret0
}

// Flush indicates an expected call of Flush.
func (mr *MockFlusherMockRecorder) Flush(rules interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Flush", reflect.TypeOf((*MockFlusher)(nil).Flush), rules)
}
